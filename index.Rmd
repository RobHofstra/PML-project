...
Then we see, that there are many variables with 19216 NA's out of 19622 observations (e.g. 'max_roll_belt').  
Furthermore, these variables appear to be aggregates. We're gonna remove these as well:
...
###Splitting the data
We’ll split the data into a training and testing set and since we have so many observations we can afford to split it in halve:
